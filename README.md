...
# Why 7600X CPU?
That CPU is rank 18 (4,221 CPU Mark, rank 1 is 4,791 but much more expensive) of >3100 CPU [Single Thread Performance](https://www.cpubenchmark.net/singleThread.html) list. More details on the PC here:  
